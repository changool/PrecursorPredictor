...
left_isolation_window_offset = 0.2 # distance for precursor prediction to the left side from the boundary of the isolation window. Unit is dalton.
...
ms2_generation_iteration_count = 3 # how many times it will iterate for MS2 generation for a certain isolation window
...
iteration_intensity_ratio_threshold = 0.3 # this parameter determine when to stop finding more precursors than one
##############################################################################################
