...
inputfile1_name = sys.argv[1]
inputfile1_name_ls = inputfile1_name.split('.')
outputfile = open (inputfile1_name_ls[0] + '_corrected.mzXML' , 'w')

left_isolation_window = 1.2 # distance for precursor prediction to the left side from the center of the isolation window. Unit is dalton.
right_isolation_window = 1 # distance for precursor prediction to the right side from the center of the isolation window. Unit is dalton.
...
for num, x in enumerate(inputfile1): # Input file
     ...
     if '</scan>' in x and '</scan>' in previous or '</scan>' in x and msLevel == 1:
        writing = 'ON'
        scan_unit_append = 'OFF'
        msms_count = 0
...
#cmd1 = 'indexmzXML ' +  inputfile1_name_ls[0] + '_corrected.mzXML'
#cmd2 = 'ren ' + inputfile1_name_ls[0] + '_corrected.mzXML.new ' + inputfile1_name_ls[0] + '_corrected_indexed.mzXML'
#os.system(cmd1)
#os.system(cmd2)